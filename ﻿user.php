...
$sungging = $putih.'[*] '.$ijo.'subcribe youtube IRKOP '.$putih.'[-] code: '.$ijo.'????';
$ads= $putih."[÷]    official channel    [÷]".$t.$ijo."[-] IRKOP ".$putih."| atau |".$ijo." IRKOP [-]";
$msgtoto = "[!] Subscribe Youtube IRKOP".$t.$red."[°] demi keamanan hentikan aktifitas bot sekarang !!!!".$t.$kuning."[•] ctrl + c";
$msgyd = "[!] please update ";
$yd_stat = true;
$vip1= false;
$weblock =[""];
...
'Haykal Herna','ifan firdiyan','Rofi Rofik','Anyar Meren','Channel Tai','[ IRKOP ]','Martus Alae','Taleri Muloie','Lise Martis','Siti Berti','Vertiem Lolite','Umam Tuner','Kilaer Kioae','Vince Aret','Defi Lana',
